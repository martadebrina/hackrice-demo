...
export default function App() {
  ...
  const [completedView, setCompletedView] = useState("mine"); // "mine" | "tutored"
  ...
  function itemsFor(tabName) {
   ...
   const mine = completed.filter((x) => x.studentId === me._id);
   const tutored = completed.filter((x) => x.tutorId === me._id);
   return completedView === "tutored" ? tutored : mine;
 }
 return [];
}
